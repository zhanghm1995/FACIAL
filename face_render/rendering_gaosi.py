...
def render(facemodel, chi):
    ...
    # colors[mask3,:] = 255.0 # Whether masked the image
...
facemodel.sp = idparams  # Speaker
facemodel.tex = texparams # Texture
facemodel.gamma = gammaparams # Gamma
...
for i in range(1, netparams.shape[0] + 1):
	...
	## Apply Gaussian filter in first 6 dimensions
